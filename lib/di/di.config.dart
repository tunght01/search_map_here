...
import '../domain/usercase/search_location_usecase.dart' as _i411;
...
_i174.GetIt init(
  ...
  gh.factory<_i411.SearchLocationUseCase>(
      () => _i411.SearchLocationUseCase(gh<_i259.SearchRepository>()));
  gh.factory<_i491.SearchCubit>(
      () => _i491.SearchCubit(gh<_i411.SearchLocationUseCase>()));
  return getIt;
}
